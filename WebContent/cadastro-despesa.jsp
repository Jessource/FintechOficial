		...
		<input type="hidden" value ="cadastrar" name="acao">
			...
			<div class="col-4 mt-5">
				<div class="form-group">
					...
					<input type="text" name="dataVenc"  class="input-area form-text form-control" required id="date" required maxlength="10" formControlName="dataVenc"/>
				</div>
			</div>
			<div class="col-4 mt-5">
				<div class="form-group">
				    <label for="dataPag">Data de Pagamento</label>
					<input type="text" name="dataPag"  class="input-area form-text form-control" required id="date" required maxlength="10" formControlName="dataPag"/>
				</div>
			</div>
			<div class="col-4 mt-5">
