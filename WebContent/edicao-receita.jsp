		...
		<input type ="hidden" value ="${receita.codigo }" name ="codigo">
			...
			<div class="col-4 mt-5">
				<div class="form-group">
					...
					<input type="text" name="dtRecebimento" value='<fmt:formatDate value="${receita.dtRecebimento.time}" pattern="dd/MM/yyyy"/>' class="input-area form-text form-control" required id="date" required maxlength="10" formControlName="dtRecebimento"/>
				</div>
			</div>
			<div class="form-group">
			<label for="id-categoria">Categoria</label>
			<select name="catReceita" id="id-categoria" class="form-control">
				<option value="0">Selecione</option>
				<c:forEach items="${categorias}" var="c">
					<c:if test="${c.codigo == receita.catReceita.codigo}">
